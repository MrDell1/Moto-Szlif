...
?>
<div id="main">
  <div class="flex items-center px-12 justify-between">
    <div>
      <a href="index.php" style="text-decoration: none;">
        <h1 class="text-4xl font-bold">MOTO-SZLIF <sup>&reg</sup> </h1>
      </a>
    </div>
    <div id="inf">
      <div id="tel">
        <div id="dryn"><span> <i class="fas fa-phone"></i></span></div>
        <div id="num" class="godz">Zadzwoń <br> <span>1234567890</span></div>
      </div>
      <div id="prac">
